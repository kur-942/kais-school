          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
              <div className="bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-green-100">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500">Affichés</p>
                    <p className="text-base sm:text-lg font-semibold text-gray-800">{displayedCourses.length}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-green-100">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    <p className="text-xs sm:text-sm text-gray-500">Vidéos</p>
                    <p className="text-base sm:text-lg font-semibold text-gray-800">
                      {displayedCourses.filter(c => c.content_type === 'video').length}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 sm:p-4 shadow-sm border border-green-100">
                <div className="flex items-center gap-2 sm:gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-base sm:text-lg font-semibold text-gray-800">{filteredCourses.length}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {filteredCourses.length === 0 && !isLoading ? (
              <div className="text-center py-12 bg-white rounded-xl border border-green-100">
                ...
                <p className="text-gray-500 mb-4">Aucun cours ne correspond à vos filtres.</p>
                <button
                  onClick={() => useCourseStore.getState().clearFilters()}
